...
public class ProfQuestionRepliesAdapter extends RecyclerView.Adapter<ProfQuestionRepliesAdapter.ViewHolder>{
    ...
    public ProfQuestionRepliesAdapter(Context context, ArrayList<ProfessorQuestion> list) {
